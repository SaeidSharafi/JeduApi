...
/**
 * Request body for refunding one whole Bundle Purchase.
 *
 * A Bundle refund is a single indivisible commercial operation: every component
 * line is refunded together. The deduction policy is expressed either as a
 * fixed amount or as a percentage of the Bundle's snapshotted Base Value.
 */
final class RefundBundlePurchaseData extends Data
{
    ...
    public function bodyParameters(): array
    {
        return [
            'deduction_amount' => [
                'description' => 'Flat deduction in Rials applied against the Bundle Base Value.',
                'example'     => 100000,
            ],
            'deduction_percent' => [
                'description' => 'Percentage deduction applied against the Bundle Base Value.',
                'example'     => 10,
            ],
            'skip_gateway' => [
                'description' => 'Skip the payment gateway call and complete the refund with a note.',
                'example'     => false,
            ],
            'admin_notes' => [
                'description' => 'Optional admin notes.',
                'example'     => 'Bundle refund requested by the customer.',
            ],
            'receiver_name' => [
