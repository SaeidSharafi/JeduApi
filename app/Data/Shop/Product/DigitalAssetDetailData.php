...
final class DigitalAssetDetailData extends Data
{
    public function __construct(
        ...
        public bool $provides_certificate = false,
        public ?array $faq,
    ...
    public static function fromModel(Product $product, ProductPriceData $data): self
    {
        ...
        return self::from(
            [
                ...
                'version'                  => $product->productable->version,
                'page_count'               => $product->productable->page_count,
                'duration_seconds'         => $product->productable->duration_seconds,
