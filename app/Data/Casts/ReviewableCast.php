...
final readonly class ReviewableCast implements Cast
{
    ...
    public function cast(DataProperty $property, mixed $value, array $properties, CreationContext $context): mixed
    {
        ...
        if (! ($value instanceof ReviewableContract)) {
            throw new InvalidArgumentException('Value must implement ReviewableContract, '.gettype($value).' given.');
        }
        ...
        return match (true) {
            ...
            default                        => throw new InvalidArgumentException('Unsupported reviewable type: '.get_class($value)),
        };
