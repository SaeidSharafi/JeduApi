...
final class DepositToWalletController extends Controller
{
     ...
     *
     * @responseFile 201 resources/responses/admin/wallet/deposit.json
     * @responseFile 422 resources/responses/422.json
     */
    public function __invoke(DepositToWalletData $data, User $user, DepositToWalletAction $action): ApiResponseInterface
    {
        $wallet = $user->wallet;
