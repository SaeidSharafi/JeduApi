...
return [
    ...
    'ignore_exceptions' => [
        ...
        \App\Exceptions\ModelHasRelationshipDataException::class,
        \App\Exceptions\Payment\OrderFullyPaidException::class,
        \App\Exceptions\Payment\InvalidPaymentPurposeException::class,
        \App\Exceptions\Payment\PaymentException::class,
        \App\Exceptions\Payment\PaymentTransactionNotFoundException::class,
        \App\Exceptions\Payment\DuplicatePaymentException::class,
        \App\Exceptions\CustomValidationException::class,
        \App\Exceptions\Payment\InvalidPaymentPurposeException::class,
        \App\Exceptions\InvalidJalaliDateException::class,
        \App\Exceptions\RefundGatewayException::class,
        \App\Exceptions\UserDoesNotHavePasswordException::class,
        \App\Exceptions\UserHasPasswordException::class,
        \App\Exceptions\UserNotFoundException::class,
        \App\Exceptions\Integrations\ExternalProvisioningException::class,
