...
describe('BlogCategoryController List & Filter', function (): void {
    it('should list categories', function (): void {
        ...
        $response = $this->getJson(route('api.v1.admin.blog.categories.index'));
        $response->assertOk();
    ...
    it('should filter by name', function (): void {
        ...
        $response = $this->getJson(route('api.v1.admin.blog.categories.index', ['filter' => ['name' => 'TechX']]));
        $response->assertOk();
    ...
    it('should filter by slug', function (): void {
        ...
        $response = $this->getJson(route('api.v1.admin.blog.categories.index', ['filter' => ['slug' => 'unique-slug']]));
        $response->assertOk();
        $response->assertJsonCount(1, 'data.data');
    ...
    it('should sort by name', function (): void {
        ...
        $response = $this->getJson(route('api.v1.admin.blog.categories.index', ['sort' => 'name']));
        $response->assertOk();
...
describe('BlogCategoryController CRUD', function (): void {
    it('should create a category', function (): void {
        ...
        $response = $this->postJson(route('api.v1.admin.blog.categories.store'), $data);
    ...
    it('should show a category', function (): void {
        ...
        $response = $this->getJson(route('api.v1.admin.blog.categories.show', ['category' => $category]));
        $response->assertOk();
    ...
    it('should return 404 for non-existent category', function (): void {
        $this->authorized_user([PermissionEnum::BLOG_CATEGORY_VIEW]);
        $response = $this->getJson(route('api.v1.admin.blog.categories.show', ['category' => 999999]));
    ...
    it('should update a category', function (): void {
        ...
        $response = $this->putJson(route('api.v1.admin.blog.categories.update', ['category' => $category]), $data);
        $response->assertOk();
    ...
    it('should not update with missing required fields', function (): void {
        $this->authorized_user([PermissionEnum::BLOG_CATEGORY_UPDATE]);
        $category = BlogCategory::factory()->create();
        $response = $this->putJson(route('api.v1.admin.blog.categories.update', ['category' => $category]), []);
        $response->assertUnprocessable();
        $response->assertJsonValidationErrors(['name']);
    });
    ...
    it('should delete a category', function (): void {
        ...
        $category = BlogCategory::factory()->create();
        $response = $this->deleteJson(route('api.v1.admin.blog.categories.destroy', ['category' => $category]));
        $response->assertOk();
    ...
    it('should return 404 for non-existent category on delete', function (): void {
        $this->authorized_user([PermissionEnum::BLOG_CATEGORY_DELETE]);
        $response = $this->deleteJson(route('api.v1.admin.blog.categories.destroy', ['category' => 999999]));
        $response->assertNotFound();
    });
