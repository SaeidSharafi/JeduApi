...
test('staff can initiate authentication with email', function (): void {
...
test('staff can initiate authentication with phone', function (): void {
    $staff = Staff::factory()->create([
        'phone'    => '09351236547',
        'password' => null,
    ]);
...
test('non existent staff gets error', function (): void {
    $response = $this->postJson(\route('api.v1.admin.auth.initiate'), [
...
test('staff can reset otp', function (): void {
...
test('staff can resend otp with phone', function (): void {
    $staff = Staff::factory()->create(['phone' => '09326542145']);
    ...
    Notification::assertSentTo($staff, OtpSmsNotification::class);
});
test('staff with password gets password login action', function (): void {
...
test('staff can verify otp and login', function (): void {
...
test('staff can verify otp and login with phone', function (): void {
    $staff        = Staff::factory()->create(['phone' => '09301234567']);
    $trackingCode = 'test-tracking';

    Cache::put('otp_09301234567_staff_value_SIGNIN', new OtpDto($this->otpCode, $trackingCode), 300);
...
test('staff can login with password', function (): void {
    $staff = Staff::factory()->create([
        'email'    => 'staff@example.com',
        'password' => Hash::make('password123'),
    ]);
...
test('non existent staff can not verify otp', function (): void {
...
test('staff can logout', function (): void {
    $staff = Staff::factory()->create();
