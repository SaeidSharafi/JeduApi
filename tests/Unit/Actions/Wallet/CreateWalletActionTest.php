...
it('successfully creates a wallet for user', function () {
    $user = User::factory()->create();
...
it('creates wallet with zero balances by default', function () {
    $user = User::factory()->create();
    $user->wallet->delete();
...
it('creates wallet with suspended status', function () {
    $user = User::factory()->create();
    $user->wallet->delete();
...
it('creates wallet with all valid status enums', function () {
...
it('properly associates wallet with user relationship', function () {
    $user = User::factory()->create();
    $user->wallet->delete();
