...
describe('PaymentServiceProvider', function () {
    ...
    it('registers wallet payment processor as singleton', function () {
    ...
    it('registers bank transfer payment processor as singleton', function () {
    ...
    it('registers payment processor factory as singleton', function () {
    ...
    it('payment processor factory is created with all tagged processors', function () {
    ...
    it('ensures payment processor tag constant is accessible', function () {
        expect(PaymentServiceProvider::PAYMENT_PROCESSOR_TAG)->toBe('payment.processors');
    });

    it('verifies all processors implement the contract', function () {
        $taggedProcessors = $this->app->tagged(PaymentServiceProvider::PAYMENT_PROCESSOR_TAG);
...
describe('PaymentProcessorFactory Integration', function () {
    ...
    it('returns correct processor for wallet payment method', function () {
    ...
    it('returns correct processor for bank transfer payment method', function () {
    ...
    it('returns same processor instance for multiple calls with same method', function () {
    ...
    it('can handle all registered payment methods sequentially', function () {
        $registeredMethods = [
    ...
    it('verifies error message format for unsupported methods', function () {
        $unsupportedMethods = [
