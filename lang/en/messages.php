...
return [
    ...
    'product' => [
        ...
        'bundle_changed'                      => 'This Bundle changed after it was added to your cart. Please confirm it again.',
        'bundle_default_name'                 => 'this bundle',
        'bundle_customer_unavailable'         => 'The bundle ":name" is unavailable for purchase at the moment.',
        'bundle_components_required'          => 'A Bundle must contain at least one component before it can be purchased.',
        'bundle_component_capacity_exceeded'  => 'A Bundle component does not have enough remaining capacity.',
        'bundle_review_components_ineligible' => 'Every Bundle component, Product, and Term must be published and eligible before review can be cleared.',
        'bundle_review_only_for_bundles'      => 'Only a Bundle delivery option can be reviewed.',
        'bundle_components_only_for_bundle'   => 'Components are only valid for Bundle products.',
        'bundle_components_unique_required'   => 'Components must contain unique existing delivery options.',
        'bundle_component_reference_invalid'  => 'Every component must reference an existing non-nested delivery option.',
        'bundle_component_nested_invalid'     => 'Nested Bundle components are not allowed.',
