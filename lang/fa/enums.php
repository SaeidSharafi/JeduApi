...
return [
    ...
    'ProvisioningStatusEnum' => [
        ...
        'healthy'                => 'بدون مشکل / سالم',
        'degraded'               => 'با اختلال',
        'manual_action_required' => 'نیازمند بررسی دستی',
    ],
    'ProvisioningReadinessEnum' => [
        'ready'    => 'آماده',
        'disabled' => 'غیرفعال',
        'invalid'  => 'نامعتبر',
    ],
    'ProvisioningOutcomeStatusEnum' => [
        'success'                => 'موفق',
        'failed'                 => 'ناموفق',
        'manual_action_required' => 'نیازمند اقدام دستی',
        'waived'                 => 'صرف‌نظرشده',
    ],
    'ProvisioningAttemptStatusEnum' => [
        'queued'                 => 'در صف',
        'running'                => 'در حال اجرا',
        'succeeded'              => 'موفق',
        'retry_scheduled'        => 'تلاش مجدد زمان‌بندی شد',
        'failed'                 => 'ناموفق',
        'manual_action_required' => 'نیازمند اقدام دستی',
    ],
    'ProvisioningProviderEnum' => [
        'ims'         => 'IMS',
        'moodle'      => 'Moodle',
